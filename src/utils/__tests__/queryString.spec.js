...
describe('Query String to Object', () => { 
    it('Should create a valid object when an object is passed', () => { 
    ...
    it.skip('Should create a valid query string when the object contains empty values or undefined', () => { 
           const obj = {
            name: "Tiago",
            age: "28",
            country: "Brazil",
    ...
    it.skip('Should create a valid query string scaping special characters', () => { 
        const obj = {
            name: "Tiago",
            age: "28",
            country: "Brazil",
    ...
    it.skip('Should throw an error when the object contains nested objects', () => {
        const obj = {
            name: "Tiago",
            age: "28",
            country: "Brazil",
